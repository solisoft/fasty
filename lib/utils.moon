...
get_nested = (arr, key) ->
  ...
  for k, item in pairs keys do arr = arr[item]
  arr
--------------------------------------------------------------------------------
