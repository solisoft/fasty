...
const model = function() {
  var partials = db._query("FOR doc in partials RETURN [doc.slug, doc.name]").toArray();
  return {
    model: [
      ...
      { tab: "CSS" },
      { r: true, c: "1-1", n: "i_css", t: "code:text", j: "joi.any()", l: "Vendors CSS" },
      { r: true, c: "1-1", n: "scss", t: "code:scss", j: "joi.any()", l: "CSS/Sass" },
      { tab: "JS" },
      { r: true, c: "1-1", n: "i_js", t: "code:text", j: "joi.any()", l: "Vendors JS" },
