...
<user_crud_edit>
  ...
  <form onsubmit="{ save_form }" class="uk-form" id="{opts.id}_crud_user">
  </form>
...
<user_edit>
  <virtual if={can_access}>
    ...
    <ul class="uk-switcher uk-margin">
      <li>
        <h3>Editing user</h3>
        <form onsubmit="{ save_form }" class="uk-form" id="form_user">
        </form>
...
<user_new>
  <virtual if={can_access}>
    <h3>Creating user</h3>
    <form onsubmit="{ save_form }" class="uk-form" id="form_new_user">
    </form>
  </virtual>
  <virtual if={!can_access && loaded}>
    Sorry, you can't access this page...
...
<users>
  <virtual if={can_access}>
    <div class="uk-float-right">
      <a href="#users/new" class="uk-button uk-button-small uk-button-default"><i class="fas fa-plus"></i> New user</a>
