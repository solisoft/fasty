...
<layout_crud_edit>
  ...
  <form onsubmit="{ save_form }" class="uk-form" id="{opts.id}_crud_layout">
  </form>
  ...
  <virtual if={can_access}>
    ...
    <ul class="uk-switcher uk-margin">
      <li>
        ...
        <form onsubmit="{ save_form }" class="uk-form" id="form_layout">
        </form>
...
<layout_new>
  <virtual if={can_access}>
    ...
    <form onsubmit="{ save_form }" class="uk-form" id="form_new_layout">
    </form>
  </virtual>
  <virtual if={!can_access && loaded}>
    Sorry, you can't access this page...
...
<layouts>
  <virtual if={can_access}>
    <div class="uk-float-right">
      <a href="#layouts/new" class="uk-button uk-button-small uk-button-default"><i class="fas fa-plus"></i> New layout</a>
