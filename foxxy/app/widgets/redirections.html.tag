...
<redirection_crud_edit>
  <a href="#" class="uk-button uk-button-link" onclick={ goback }>Back to { opts.id }</a>
  <form onsubmit="{ save_form }" class="uk-form" id="{opts.id}_crud_redirection">
  </form>
...
<redirection_edit>
  <virtual if={can_access}>
    ...
    <ul class="uk-switcher uk-margin">
      <li>
        <h3>Editing redirection</h3>
        <form onsubmit="{ save_form }" class="uk-form" id="form_redirection">
        </form>
...
<redirection_new>
  <virtual if={can_access}>
    <h3>Creating redirection</h3>
    <form onsubmit="{ save_form }" class="uk-form" id="form_new_redirection">
    </form>
  </virtual>
  <virtual if={!can_access && loaded}>
    Sorry, you can't access this redirection...
...
<redirections>
  <virtual if={can_access}>
    <div class="uk-float-right">
      <a href="#redirections/new" class="uk-button uk-button-small uk-button-default"><i class="fas fa-plus"></i> New redirection</a>
