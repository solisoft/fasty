            ...
            <div class="uk-grid uk-grid-small">
              <div class="uk-width-3-4">
                <select class="uk-select" ref="folder">
                  <option value={folders[0].root._key} selected={folders[0].root._key == partial.folder_key}>Root</option>
                  <option each={f in folders} value={f.folder._key} selected={f.folder._key == partial.folder_key}>{ pathName(f.path) }</option>
                </select>
              </div>
