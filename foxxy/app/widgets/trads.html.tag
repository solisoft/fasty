...
<trad_crud_edit>
  ...
  <form onsubmit="{ save_form }" class="uk-form" id="{opts.id}_crud_trad">
  </form>
...
<trad_edit>
  <virtual if={can_access}>
    ...
    <ul class="uk-switcher uk-margin">
      <li>
        <h3>Editing trad</h3>
        <form onsubmit="{ save_form }" class="uk-form" id="form_trad">
        </form>
...
<trad_new>
  <virtual if={can_access}>
    <h3>Creating trad</h3>
    <form onsubmit="{ save_form }" class="uk-form" id="form_new_trad">
    </form>
  </virtual>
  <virtual if={!can_access && loaded}>
    Sorry, you can't access this page...
...
<trads>
  <virtual if={can_access}>
    <div class="uk-float-right">
      <a href="#trads/new" class="uk-button uk-button-small uk-button-default"><i class="fas fa-plus"></i> New trad</a>
