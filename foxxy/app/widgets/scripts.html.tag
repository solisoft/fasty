...
<script_crud_edit>
  ...
  <form onsubmit="{ save_form }" class="uk-form" id="{opts.id}_crud_script">
  </form>
...
<script_new>
  <virtual if={can_access}>
    <h3>Creating script</h3>
    <form onsubmit="{ save_form }" class="uk-form" id="form_new_script">
    </form>
  </virtual>
  <virtual if={!can_access && loaded}>
    Sorry, you can't access this page...
...
<scripts>
  <virtual if={can_access}>
    <div class="uk-float-right">
      <a href="#scripts/new" class="uk-button uk-button-small uk-button-default"><i class="fas fa-plus"></i> New script</a>
